...
INSERT INTO questionario (que_nome, que_codigo)
VALUES ('Plano de Ação', 'pla');
INSERT INTO pergunta (questionario_id, per_descricao, per_tipo, per_name_id, placeholder, per_required)
VALUES (2, 'O objetivo com este plano de ação é ...', 'text', 'txtObjetivoPlanoDeAcao', DEFAULT, DEFAULT);
INSERT INTO pergunta (questionario_id, per_descricao, per_tipo, per_name_id, placeholder, per_required)
VALUES (2, 'O que eu vou fazer (ações práticas)?', 'text', 'txtOqueVouFazer', DEFAULT, DEFAULT);
INSERT INTO pergunta (questionario_id, per_descricao, per_tipo, per_name_id, placeholder, per_required)
VALUES (2, 'Existe algum obstáculo ou dificuldade?', 'text', 'txtObstaculoOuDificuldade', DEFAULT, DEFAULT);
INSERT INTO pergunta (questionario_id, per_descricao, per_tipo, per_name_id, placeholder, per_required)
VALUES (2, 'Como vou lidar com esses obstáculos ou dificuldades?
        ', 'text', 'txtLidarObstaculosOuDificuldade', DEFAULT, DEFAULT);
INSERT INTO pergunta (questionario_id, per_descricao, per_tipo, per_name_id, placeholder, per_required)
VALUES (2, 'Quando vou colocar este plano na prática?
