...
(
    ...
    FOREIGN KEY (`usuario_tipo_id`) REFERENCES u217629253_dialog.usuario_tipo (usuario_tipo_id)
) ENGINE = MyISAM;
...
(
    ...
    FOREIGN KEY (`usuario_id`) REFERENCES u217629253_dialog.usuario (usuario_id)
) ENGINE = MyISAM;
...
(
    ...
    FOREIGN KEY (`psicologo_id`) REFERENCES u217629253_dialog.psicologo (psicologo_id)
) ENGINE = MyISAM;
...
(
    ...
    FOREIGN KEY (`pergunta_id`) REFERENCES u217629253_dialog.pergunta (pergunta_id),
    FOREIGN KEY (`aplicacao_questionario_id`) REFERENCES u217629253_dialog.aplicacao_questionario (aplicacao_questionario_id)
) ENGINE = MyISAM;
